...
def fetch_search_results(keyword, published_after, video_type):
...
if st.button("Search"):
    ...
    results = fetch_search_results(keyword, after_str, type_filter)
    outlier_rows = []
    for video_id, channel_id in results:
        ...
        if type_filter == "Shorts" and not vid_info['isShort']:
            continue
        elif type_filter == "Videos" and vid_info['isShort']:
            continue
